# VENDORED from https://github.com/DataWaveProject/nonlocal_gwfluxes (tag 1.0.0,
# commit 940d951, MIT License), archived as DOI 10.5281/zenodo.16415113.
# Unmodified except this header; vendored so released checkpoints load against
# the exact published architecture. See ASSETS.md.
import numpy as np
import torch
